---
name: deslop
description: Remove AI-generated slop (extra comments, defensive checks, single-use vars, inconsistent style) from the current branch's diff against main. Does not stage changes.
---
